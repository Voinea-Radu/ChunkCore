package dev.lightdream.ranks.manager;

import dev.lightdream.api.events.player.UltraPrisonPlayerPrestigeEvent;
import dev.lightdream.api.events.player.UltraPrisonPlayerRankUpEvent;
