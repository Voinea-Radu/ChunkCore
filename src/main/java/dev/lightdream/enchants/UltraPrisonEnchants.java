package dev.lightdream.enchants;

import dev.lightdream.enchants.api.UltraPrisonEnchantsAPIImpl;
import dev.lightdream.enchants.enchants.UltraPrisonEnchantment;
import dev.lightdream.enchants.enchants.implementations.LuckyBoosterEnchant;
import dev.lightdream.enchants.gui.DisenchantGUI;
import dev.lightdream.enchants.gui.EnchantGUI;
import dev.lightdream.enchants.managers.EnchantsManager;
import lombok.Getter;
import dev.lightdream.UltraPrisonCore;
import dev.lightdream.UltraPrisonModule;
import dev.lightdream.config.FileManager;
import dev.lightdream.enchants.api.UltraPrisonEnchantsAPI;
