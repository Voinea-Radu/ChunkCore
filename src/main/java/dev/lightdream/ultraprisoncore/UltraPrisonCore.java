...
import dev.lightdream.ultraprisoncore.autominer.UltraPrisonAutoMiner;
import dev.lightdream.ultraprisoncore.autosell.UltraPrisonAutoSell;
import dev.lightdream.ultraprisoncore.config.FileManager;
import dev.lightdream.ultraprisoncore.database.Database;
import dev.lightdream.ultraprisoncore.database.DatabaseCredentials;
import dev.lightdream.ultraprisoncore.database.SQLDatabase;
import dev.lightdream.ultraprisoncore.database.implementations.MySQLDatabase;
import dev.lightdream.ultraprisoncore.database.implementations.SQLiteDatabase;
import dev.lightdream.ultraprisoncore.enchants.UltraPrisonEnchants;
import dev.lightdream.ultraprisoncore.friends.UltraPrisonFriends;
import dev.lightdream.ultraprisoncore.gangs.GangsPlugin;
import dev.lightdream.ultraprisoncore.gems.UltraPrisonGems;
import dev.lightdream.ultraprisoncore.help.HelpGui;
import dev.lightdream.ultraprisoncore.tokens.UltraPrisonTokens;
import dev.lightdream.ultraprisoncore.utils.InventoryManager;
import dev.lightdream.ultraprisoncore.utils.Messages;
import dev.lightdream.ultraprisoncore.utils.SkullUtils;
import dev.lightdream.ultraprisoncore.utils.compat.CompMaterial;
import dev.lightdream.ultraprisoncore.utils.gui.ClearDBGui;
import lombok.Getter;
import dev.lightdream.ultraprisoncore.multipliers.UltraPrisonMultipliers;
import dev.lightdream.ultraprisoncore.pickaxelevels.UltraPrisonPickaxeLevels;
import dev.lightdream.ultraprisoncore.placeholders.UltraPrisonMVdWPlaceholder;
import dev.lightdream.ultraprisoncore.placeholders.UltraPrisonPlaceholder;
import dev.lightdream.ultraprisoncore.ranks.UltraPrisonRankup;
import dev.lightdream.ultraprisoncore.utils.Persist;
