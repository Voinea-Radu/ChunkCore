package dev.lightdream.ultraprisoncore.gangs.gang;

import dev.lightdream.ultraprisoncore.gangs.config.Lang;
import dev.lightdream.ultraprisoncore.gangs.config.Settings;
import dev.lightdream.ultraprisoncore.gangs.database.Callback;
import dev.lightdream.ultraprisoncore.gangs.event.GangCreateEvent;
import dev.lightdream.ultraprisoncore.gangs.event.PlayerJoinGangEvent;
        ...
        if (!var4.isCancelled()) {
            ...
            this.main.getDataManager().createGang(var3, new Callback<Integer>() {
                public void onSuccess(Integer var1) {
                    var3.setId(var1);
                    Bukkit.getScheduler().runTask(GangManager.this.main.getCore(), () -> {
