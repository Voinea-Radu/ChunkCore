package dev.lightdream.gangs;

import com.google.gson.Gson;
import dev.lightdream.gangs.command.*;
import dev.lightdream.gangs.config.Lang;
import dev.lightdream.gangs.config.Settings;
import dev.lightdream.gangs.core.BConfig;
import dev.lightdream.gangs.database.DataManager;
import dev.lightdream.gangs.database.MySqlDataManager;
import dev.lightdream.gangs.database.SqliteDataManager;
import dev.lightdream.gangs.dependency.CombatHandler;
import dev.lightdream.gangs.dependency.MvdwPlaceholderHandler;
import dev.lightdream.gangs.dependency.PlaceholderApiHandler;
import dev.lightdream.gangs.fight.FightManager;
import dev.lightdream.gangs.gang.GangManager;
import dev.lightdream.gangs.player.PlayerManager;
import dev.lightdream.gangs.task.SaveDataTask;
import lombok.Getter;
import dev.lightdream.UltraPrisonCore;
import dev.lightdream.UltraPrisonModule;
import dev.lightdream.gangs.listener.CrackShotListener;
import dev.lightdream.gangs.listener.EntityListener;
import dev.lightdream.gangs.listener.GangsListener;
import dev.lightdream.gangs.listener.PlayerListener;
